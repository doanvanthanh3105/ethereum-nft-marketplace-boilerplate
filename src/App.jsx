...
import OnSaleNFT from 'components/OnSaleNFT';
import Favorites from 'components/Favorites';
import CreateToken from 'components/createToken';
import BidItems from 'components/BidItems';
import MyBidItems from 'components/MyBidItems';
      ...
      <Router>
        <Header style={styles.header}>
          ...
          <Menu
            ...
            <Menu.Item key='onSaleNft'>
              <NavLink to='/OnSaleNFT'>🖼 NFT On Sale</NavLink>
            </Menu.Item>
            <Menu.Item key='nft'>
            ...
            <Menu.Item key='allBidItems'>
              <NavLink to='/BidItems'>📑 Bid Items</NavLink>
            </Menu.Item>
            <Menu.Item key='myBidItems'>
              <NavLink to='/MyBidItems'>📑 My Bidding List</NavLink>
            </Menu.Item>
          </Menu>
        ...
        <div style={styles.content}>
          <Switch>
            ...
            <Route path='/MyBidItems'>
              <MyBidItems />
            </Route>
            <Route path='/NftBalance'>
              <NFTBalance />
            </Route>
            <Route path='/OnSaleNFT'>
              <OnSaleNFT />
            </Route>
